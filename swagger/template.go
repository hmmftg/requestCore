...
<head>
  <meta charset="UTF-8">
  <title>{{.Title}}</title>
  <link rel="stylesheet" type="text/css" href="{{.Base}}/{{.Name}}/swagger/assets/swagger-ui.css" >
  <link rel="icon" type="image/png" href="{{.Base}}/{{.Name}}/swagger/assets/favicon-32x32.png" sizes="32x32" />
  <link rel="icon" type="image/png" href="{{.Base}}/{{.Name}}/swagger/assets/favicon-16x16.png" sizes="16x16" />
  <style>
    html
    {
...
<script src="{{.Base}}/{{.Name}}/swagger/assets/swagger-ui-bundle.js"> </script>
<script src="{{.Base}}/{{.Name}}/swagger/assets/swagger-ui-standalone-preset.js"> </script>
<script>
