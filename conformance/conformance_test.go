...
import (
	...
	"github.com/hmmftg/requestCore/conformance"
	"github.com/hmmftg/requestCore/httpsemantics"
	"github.com/hmmftg/requestCore/idempotency"
	"github.com/hmmftg/requestCore/response"
)

// TestBearerChallengeConformance verifies that v1 httpsemantics
...
// TestRetryAfterConformance verifies that v1 httpsemantics parses
...
// TestETagConformance verifies that v1 httpsemantics parses ETags
...
// TestPreconditionConformance verifies that v1 httpsemantics evaluates
...
// TestIdempotencyKeyConformance verifies that v1 idempotency validates
...
// TestNoBodyStatusConformance verifies that v1 httpsemantics correctly
...
// TestPaginationLinkConformance verifies that v1 httpsemantics builds
...
// TestSecurityConformance_ProblemSanitization verifies that v1 Problem
...
func TestSecurityConformance_ProblemSanitization(t *testing.T) {
	for _, tc := range conformance.SecurityVectors {
		t.Run(tc.Name, func(t *testing.T) {
			// Create a Problem with the sensitive data as the cause
...
// TestSecurityConformance_SafeHeaders verifies that v1 idempotency
